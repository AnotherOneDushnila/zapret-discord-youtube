...
@REM set "BIN=%~dp0bin\"
@REM set "URL=https://raw.githubusercontent.com/bol-van/zapret/tree/master"

@REM powershell -Command "Invoke-WebRequest -Uri '%URL%/fake' -OutFile '%BIN%/fake' -UseBasicParsing"
