...
--filter-udp=49152-65535 ipset="%LISTS%ipset-roblox.txt" --dpi-desync=fake --dpi-desync-fake-unknown-udp=0x0000 --dpi-desync-any-protocol --dpi-desync-cutoff=n2 --new ^
