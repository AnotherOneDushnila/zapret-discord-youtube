...
--filter-tcp=443 --hostlist-exclude="%LISTS%hostlist-exclude.txt" --dpi-desync=fakedsplit --dpi-desync-fooling=md5sig --dup=1 --dup-cutoff=n2 --dup-fooling=md5sig --dpi-desync-split-pos=1 --new ^
